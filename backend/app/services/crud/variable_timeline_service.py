...
from app.services.crud.logic_node_service import _node_from_graph, _parse_datetime
...
def _node_from_graph_by_id(node_id: str) -> LogicNodeResponse:
    ...
    from app.services.crud.logic_node_service import get_node  # pylint: disable=import-outside-toplevel
