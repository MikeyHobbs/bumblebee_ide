...
from app.services.write_back import append_function_to_file, replace_function_in_file
...
def _extract_variables_for_node(
    ...
    """
    from app.services.ast_parser import ParsedNode  # pylint: disable=import-outside-toplevel
    from app.services.variable_extractor import extract_variables  # pylint: disable=import-outside-toplevel
